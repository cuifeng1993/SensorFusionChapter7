...
private:
     ...
     * @return void
     */
    void UpdateOdomEstimation(Eigen::Vector3d &linear_acc_mid,Eigen::Vector3d &linear_angular_mid);
    ...
    void SetProcessEquation(
        const Eigen::Matrix3d &C_nb, const Eigen::Vector3d &f_n, const Eigen::Vector3d &w_n
    );
    /**
     ...
     * @return void
     */
    void UpdateProcessEquation(const Eigen::Vector3d &linear_acc_mid, const Eigen::Vector3d &linear_angular_mid);
